        ...
        <div className="max-h-[70vh] space-y-6 overflow-y-auto px-5 py-5">
          ...
          <section>
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-edge-soft p-3 transition hover:bg-panel-2/60">
              ...
              />
              <span>
                <span className="block text-sm font-medium text-ink">Stockfish embarcado</span>
            ...
            <label className="mt-2 flex cursor-pointer items-start gap-3 rounded-lg border border-edge-soft p-3 transition hover:bg-panel-2/60">
              <input
                ...
                name="engine-src"
                checked={useCustom}
                onChange={() => setEnginePath(settings.enginePath || "/usr/bin/stockfish")}
                className="mt-0.5 accent-[var(--brand)]"
              />
              <span className="min-w-0 flex-1">
                <span className="block text-sm font-medium text-ink">Caminho customizado</span>
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              {result && (
                ...
                >
                  ...
                  {result.ok ? result.name ?? "Engine respondeu (uciok)" : result.error ?? "Falhou"}
                </span>
              )}
            </div>
          </section>
