        ...
        {(["file", "paste"] as Mode[]).map((m) => (
          <button
            ...
            className={`rounded-md px-4 py-1.5 text-sm font-medium transition ${
              mode === m ? "bg-brand text-bg shadow" : "text-ink-dim hover:text-ink"
            }`}
          >
      ...
      {mode === "file" ? (
        ...
        >
          ...
          <p className="text-sm text-ink">
            Arraste um arquivo <span className="font-semibold text-brand">.pgn</span>
          </p>
          <p className="mt-0.5 text-xs text-ink-faint">ou clique para procurar</p>
